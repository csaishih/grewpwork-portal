...
(function() {
  ...
  Bubbles = function() {
    ...
    updateActive = function(id) {
      ...
      if (id.length > 0) {
        return d3.select("#status").html("The word " + id + " is now active");
      } else {
        return d3.select("#status").html("No word is active");
      }
    };
  ...
  texts = [
    {
      key: "sherlock",
      file: window.user.screen_name.concat(".csv"),
    ...
    return d3.csv("Visualizations/bubble_cloud/data/" + text.file, display);
